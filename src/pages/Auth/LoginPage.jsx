    ...
    <div className="min-h-screen bg-gradient-to-br from-nebula-50 to-green-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Sign in to Nebula Farm Manager</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="mt-6 text-center text-sm">
            ...
            <Link to="/register" className="text-nebula-600 font-medium hover:text-nebula-700">
              Sign up
            </Link>
          </div>
        </div>
        ...
        <p className="text-center text-xs text-gray-500 mt-8">
          Nebula Fresh Produce Farm Management System
        </p>
      </div>
    </div>
  )
